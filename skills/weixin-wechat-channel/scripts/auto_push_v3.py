...
def push(title, html_file, digest):
    ...
    article = {'title': title, 'author': '', 'digest': digest, 'content': content, 'content_source_url': '', 'need_open_comment': 1, 'only_fans_can_comment': 0}
...
if __name__ == '__main__':
    if len(sys.argv) < 4: print('用法: python3 auto_push_v3.py <title> <text_file> <digest>'); sys.exit(1)
