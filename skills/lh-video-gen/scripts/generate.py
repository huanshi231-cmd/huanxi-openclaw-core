...
示例：
  ...
  python3 generate.py script.md --tts-command "my-tts {text} -o {output}"
    ...
    parser.add_argument("-r", "--rate", default=DEFAULT_RATE, help=f"Speech rate")
    parser.add_argument("-w", "--width", type=int, default=DEFAULT_WIDTH, help="Video width")
    ...
    parser.add_argument("--no-subs", action="store_true", help="No subtitles（字幕已渲染在图片中）")
